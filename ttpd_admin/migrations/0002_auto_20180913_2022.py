# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-09-13 12:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('path', models.FileField(blank=True, upload_to=ttpd_admin.models.technology_assets_path)),
        ...
        migrations.AddField(
            model_name='technologyassets',
            name='asset_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ttpd_admin.TechnologyAssetTypes'),
        ),
        migrations.AddField(
            model_name='technologyassets',
            name='technology',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assets', to='ttpd_admin.Technologies'),
        ),
        migrations.AddField(
